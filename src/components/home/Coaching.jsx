      ...
      return (
        <div key={coaching.id} className='text-white text-lg lg:mx-auto py-10 lg:py-16 w-full xl:w-2/5 bg-coaching-blue lg:border-x-4 lg:border-r-white'>
          <div className='lg:mx-20 mx-10'>
            ...
            <p className='mb-8'>Benefit from a 1-on-1 coaching with me where I'll be directly in touch with you during your fitness journey. My coaching will be adapted to you individually in order to get the best results. Contact me and apply for a FREE call first.</p>
