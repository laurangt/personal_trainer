  ...
  return (
    <div>
      ...
      <div className='mx-10 lg:mx-40 mt-7 lg:mt-14 mb-20 text-justify text-lg'>
        ...
        <div className='flex flex-col-reverse lg:flex-row mt-4 mb-8 lg:items-center'>
          <img className="lg:w-2/5 object-cover lg:mr-10 mb-5 lg:mb-0 mr-0" id="healthycookingimg" src={healthycooking} alt="healthy cooking"/>
