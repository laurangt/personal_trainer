  ...
  return (
    <div>
      ...
      <div className='ml-40 mr-40 mt-14 mb-20 text-justify'>
        <h1 className='text-3xl text-center mb-10'>Nutrition</h1>
        ...
        <div className='flex mb-4'>
          ...
          <img className="w-2/5 object-cover" src={fruitveg} alt="fruit and vegtables"/>
        </div>
        <div className='flex mt-4'>
          <img className="w-2/5 object-cover"src={healthycooking} alt="healthy cooking"/>
        ...
        <h3 className='text-2xl mt-4 mb-4'>Nutritional Supplements</h3>
